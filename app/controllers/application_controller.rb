class ApplicationController < ActionController::Base
  ...
  def get_partner_company_name
    unless !@resultSetCompany.nil?
      sql_query = "SELECT id, name, description, COALESCE(to_phone, 'NR') AS pphone, COALESCE(website, 'NR') AS pwebsite FROM ref_partner rp WHERE id = " + @current_user.partner.to_s + ";"
      begin
