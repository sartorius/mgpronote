    ...
    $("#jsGrid").jsGrid({
        ...
        fields: [
            ...
            { name: "since", title: "Client.e depuis le", type: "text", width: 40, align: "right", headercss: "h-jsG-r" },
            {
              ...
              width: 25,
              itemTemplate: function(value, item) {
                return '<button type="submit" id="cltd-' + value + '" class="btn btn-default btn-sm btn-block bc-crt-clt" data-order="D" data-name="' + item.name + " " + item.firstname + '" value="' + value + '">' + '<i class="c-w glyphicon glyphicon-save"></i>' + '</button>';
              }
            },
            {
              name: "id",
              ...
              width: 25,
              itemTemplate: function(value, item) {
                return '<button type="submit" id="cltp-' + value + '" class="btn btn-default btn-sm btn-block bc-crt-clt" data-order="P" data-name="' + item.name + " " + item.firstname + '" value="' + value + '">' + '<i class="c-b glyphicon glyphicon-open"></i>' + '</button>';
              }
            },
            {
              name: "id",
